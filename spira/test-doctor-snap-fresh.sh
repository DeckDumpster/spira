...
# ==========================================================================
echo
echo "stale snapshot — WARN names the age:"
# ==========================================================================

printf 'SP_AT=0\n' > "$TMP/run/cockpit.env"
touch -d "300 seconds ago" "$TMP/run/cockpit.env"
stale_out="$(run_doctor)"
want "stale snapshot: WARN for stale"                 "warn  cockpit snapshot stale" "$stale_out"
...
nowant "fresh snapshot: no stale WARN"                "warn  cockpit snapshot stale"  "$fresh_out"
