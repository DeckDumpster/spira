...
SPIRA_LAND_MAXSEC SPIRA_LAND_GATE_RESERVE SPIRA_CERTIFY_PAR SPIRA_CERTIFY_SUITES SPIRA_CERTIFY_ALWAYS_COVERS SPIRA_VERDICT_TTL SPIRA_REBASE_ESCALATE_AT SPIRA_EVICTION_ESCALATE_AT SPIRA_VERDICT_WINDOW SPIRA_CHECK5_MAX_FILE SPIRA_REMEDY_WINDOW SPIRA_PR_STALL_MINS SPIRA_DEFERRAL_ESCALATE_AT
SPIRA_BROKER_BIN SPIRA_BROKER_GH_CONFIG_DIR SPIRA_BROKER_GH_TOKEN SPIRA_CZAR_PASS_BIN SPIRA_QUEUE_WATCH_BIN SPIRA_SUPERVISE_BIN SPIRA_LANDING_PASS_BIN SPIRA_TSD_BIN SPIRA_RECONCILER_BIN SPIRA_TEST_PLAN_BIN
...
export SPIRA_INSTANCE \
       ...
       SPIRA_PLAN_LABEL SPIRA_INCIDENT_LABEL SPIRA_EXPRESS_LABEL SPIRA_NO_LOOP_LABEL SPIRA_GROOM_ASK_LABEL \
       SPIRA_SUBMITTED_LABEL SPIRA_WORK_CLOSE_TYPES \
       SPIRA_TOWN SPIRA_MIRROR SPIRA_EXPORTER SPIRA_DESIGN SPIRA_WIKI SPIRA_WIKI_HOOK SPIRA_DOLT_DATA \
       SPIRA_ALERT_GLOB \
